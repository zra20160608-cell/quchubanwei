...
const ICONS: Record<string, React.ReactNode> = {
  ...
  home: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 9.5L12 3l9 6.5v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-9z"/>
      <path d="M8 21V12h8v9"/>
      <line x1="12" y1="6" x2="12" y2="6.01"/>
    </svg>
  ),
  homeActive: (
    <svg viewBox="0 0 24 24" fill="url(#brand-gradient)" stroke="none">
      <defs>
  ...
  camera: (
    <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="4" y="8" width="24" height="18" rx="4" ry="4"/>
      <circle cx="16" cy="18" r="6"/>
      <circle cx="25" cy="12" r="1.5" fill="currentColor" stroke="none"/>
      <path d="M12 8l1.5-3h5L20 8"/>
    </svg>
  ),
  upload: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  likeActive: (
    <svg viewBox="0 0 24 24" fill="#FF6B4A" stroke="none">
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
    </svg>
  ),
  comment: (
  ...
  empty: (
    <svg viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M32 8l24 12v24L32 56 8 44V20l24-12z"/>
      <path d="M32 32l24-12"/>
      <path d="M32 32v24"/>
      <path d="M32 32L8 20"/>
...
export default function Icon({ name, size = 24, color, spin, className = '', onClick }: IconProps) {
  ...
  return (
    <View className={`icon ${className}`} style={style} onClick={onClick}>
      {icon}
    </View>
  )
}
